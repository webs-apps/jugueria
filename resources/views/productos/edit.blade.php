                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="tipo" 
                                    ...
                                    <option value="venta" {{ old('tipo', $producto->tipo) === 'venta' ? 'selected' : '' }}>Venta (Productos que vendes)</option>
                                    <option value="gasto" {{ old('tipo', $producto->tipo) === 'gasto' ? 'selected' : '' }}>Gasto (Insumos que compras)</option>
                                </select>
                                @error('tipo')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-gray-400 transition-colors duration-200">
                                    <div class="space-y-1 text-center">
                                        ...
                                        @if($producto->foto)
                                            <p class="text-xs text-gray-400">Dejar vacío para mantener la imagen actual</p>
                                        @endif
                                    </div>
                                </div>
                                @error('foto')
